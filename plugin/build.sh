...
SRCS="Plugin.cs LightScriptFix.cs VoicePack.cs VoicePlayer.cs ConversationPatches.cs BorderlessWindow.cs InspectPatch.cs OptionsPatch.cs PortraitPatches.cs Variants.cs TutorialPatch.cs"
